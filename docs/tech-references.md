...
- [Detecting if React is in development or production in runtime w/o proper Webpack setup, how? : reactjs](https://www.reddit.com/r/reactjs/comments/ahlll3/detecting_if_react_is_in_development_or/)
...
- [Integrate Recoil with TypeScript to share your state across React components](https://medium.com/react-courses/integrate-recoil-with-typescript-to-share-your-state-across-react-components-8cf1a3910fae)
- [Migrate Context to Recoil](https://dev.to/malloc007/migrate-context-to-recoil-40mc)
...
- [React Router: Declarative Routing for React.js](https://reactrouter.com/core/guides/quick-start)
...
- [Building a navigation drawer with Material UI and React Router DOM](https://dev.to/rossanodan/building-a-navigation-drawer-with-material-ui-and-react-router-dom-1j6l)
- [React Router: Authenticated Routes - Nick Nish](https://www.nicknish.co/blog/react-router-authenticated-routes)
